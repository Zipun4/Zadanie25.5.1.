...
def testing():
    pytest.driver = webdriver.Chrome('D:/Project/SKILLFACTORY/ProjectSelenium/chromedriver.exe')
    pytest.driver.implicitly_wait(10)
    pytest.driver.get('http://petfriends.skillfactory.ru/login')
    pytest.driver.maximize_window()
    pytest.driver.find_element(By.ID, 'email').send_keys('shilnikov220788@gmail.com')
